...
Update 6/14/14
Note: Changes make execution of payload delayed by 20-60 seconds

+stringless get k32.dll function
+added sleep to decryption routine/API table, prevents CPU spike and delays execution
-removed log file (not cleaned yet)
